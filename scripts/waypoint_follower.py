...
═══════════════════════════════════════════════════════════
  ...
  routes_topic        default: available_routes
...
class IndoorRouteFollower(Node):
    ...
    def __init__(self):
        ...
        self.declare_parameter(
            'waypoints_file',
            os.path.expanduser('~/trov_ws/src/trov/routes/indoor_waypoints.yaml')
        )
        ...
        self.declare_parameter('routes_topic',       'available_routes')
