...
#   map_yaml_file    = os.path.join(pkg_share, 'maps', 'indoor3.yaml')
...
#       'min_height': 0.1,        # just above ground
#       'max_height': 1.5,        # below top of robot
#       'angle_min': -1.57,
#       'angle_max':  1.57,
#       'angle_increment': 0.00873,  # 1 degree resolution — was too fine before
#       'scan_time': 0.1,          # match your LiDAR 15Hz = 0.067s
#       'range_min': 1.0,
#       'range_max': 30.0,
#       'use_inf': True,
#       'concurrency_level': 1,
...
#         description='Map file name without .yaml extension (e.g. indoor3, warehouse2)'
#     )
...
#         parameters=[
#             {'use_sim_time':   False},
#             {'yaml_filename':  map_yaml_file},   # ← dynamic now
#         ],
#     )
